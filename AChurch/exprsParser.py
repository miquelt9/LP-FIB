...
class exprsParser (Parser):
    ...
    class AssignarInfixContext(AssignarContext):
        ...
        # actually a exprsParser.AssignarContext
    ...
    class ParentesisContext(TermeContext):
        ...
        # actually a exprsParser.TermeContext
        def __init__(self, parser, ctx: ParserRuleContext):
            super().__init__(parser)
            self.copyFrom(ctx)
        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    _prevctx = localctx
                    localctx = exprsParser.AplicacioContext(
                        self, exprsParser.TermeContext(
                            self, _parentctx, _parentState))
                    self.pushNewRecursionContext(
                        localctx, _startState, self.RULE_terme)
                    self.state = 40
